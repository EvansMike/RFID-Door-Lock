...
// Application needs this function to do things with the received data;
extern void handle_twi(unsigned char * data);
...
****************************************************************************/
unsigned char TWI_Master_Initialise( unsigned char );
unsigned char TWI_Transceiver_Busy( void );
unsigned char TWI_Get_State_Info( void );
void TWI_Start_Transceiver_With_Data( unsigned char * , unsigned char, unsigned char address);
...
#define TWI_GEN_BIT   0   // Bit position of the general call bit in the init byte.
